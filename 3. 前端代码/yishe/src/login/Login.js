        ...
        <Consumer>
            {
                (data)=>{ return <div className="login" className={styles.enter}>
                    <Flex id='judgeT' class="judge" direction="column" justify="center" align="center" style={{display:'none'}}>
                        <p>&nbsp;&nbsp;欢迎光临衣舍！</p>
                        <Link to="/apptab"><Button onClick={()=>{this.setState({flag:-1});}} style={{marginTop:'20%', marginLeft:'15%', color:'white', fontSize:'90%', fontWeight:'bold', width:'70%', height:'20%', backgroundColor:'rgb(36,217,238)', border:'solid 1px blue'}}>G&nbsp;&nbsp;O</Button></Link>
                    </Flex>
